...
export function AddContactLensItemForm({ shopId }: AddContactLensItemFormProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      costPrice: 0,
      price: 0,
      hsnCode: "90013000", // Standard HSN code for contact lenses
      cgstPercent: 6,
      sgstPercent: 6,
      igstPercent: 12,
      vendorName: "",
    ...
    startTransition(async () => {
      ...
      const saveLocally = async () => {
        const b = (data.brand || "GEN")
          ...
          .toUpperCase()
          .padEnd(3, "X");
        const generatedSku = `CTL-${b}000000-${Math.floor(100 + Math.random() * 900)}`;
