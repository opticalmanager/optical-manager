...
export function AddLensItemForm({ shopId, categoryDefaults, categories }: AddLensItemFormProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      costPrice: 0,
      price: 0,
      hsnCode: categoryDefaults?.hsnCode || "90015000",
    ...
    startTransition(async () => {
      ...
      const saveLocally = async () => {
        const b = (data.brand || "GEN")
          ...
          .toUpperCase()
          .padEnd(3, "X");
        const generatedSku = data.productCode || `LNS-${b}000000-${Math.floor(100 + Math.random() * 900)}`;
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    type="text"
                    placeholder="Auto-synced from matrix or e.g. -4.00 to +4.00"
                    className="h-11 border-slate-200 font-semibold text-slate-800"
                    {...register("stockPower")}
                  />
                  <p className="text-[10px] text-slate-400 mt-1">
                    Auto-calibrated as you enter lens quantities in the power matrix below.
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400 font-medium">
                      Select plus/minus sphere chart mode and enter lens unit counts across SPH and CYL powers.
                    </p>
                  </div>
                </div>
