    ...
    <div className="space-y-6 select-none text-slate-800">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          ...
          {/* Add Customer Dropdown (Single vs Bulk) */}
          <div 
            className="relative" 
            ref={addMenuRef}
                ...
                <div className="bg-white border border-slate-200 rounded-2xl shadow-xl py-1.5 divide-y divide-slate-100">
                  ...
                  <div className="p-1.5 space-y-1">
                    ...
                    >
                      ...
                      <div>
                        <span className="block font-bold text-slate-800 group-hover:text-[#0a52c3]">Add Single</span>
                        <span className="block text-[10px] text-slate-400 font-medium">Individual patient registration</span>
                      </div>
                    </button>
                    ...
                    <button
                      onClick={() => {
                        setAddMenuOpen(false);
                        router.push("/shop/customers/import");
                      }}
                      className="w-full text-left px-3 py-2.5 rounded-xl hover:bg-slate-50 transition-colors flex items-center gap-3 text-xs font-bold text-slate-700 hover:text-[#0a52c3] group cursor-pointer"
                    >
