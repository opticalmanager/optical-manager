  ...
  return (
    <div className="space-y-8 select-none max-w-[1400px] mx-auto pb-10">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        {/* Card 1: Revenue */}
        <div className="relative bg-white border border-slate-200/60 p-6 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between min-h-[120px]">
          <div className="flex items-center justify-between">
            ...
            <div className="relative">
              <button 
                ...
                className="px-2.5 py-1 rounded-full bg-slate-50 border border-slate-100 text-[10px] font-bold text-slate-500 flex items-center gap-1 hover:bg-slate-100 transition-colors cursor-pointer"
              >
                {currentLabel} ▾
              </button>
                  ...
                  <div className="absolute right-0 top-full mt-1.5 w-48 bg-white border border-slate-200 rounded-xl shadow-lg py-1.5 z-50 animate-fade-in text-left">
                    {timeframeOptions.map((opt) => (
                      <button
                        ...
                        className={`w-full px-4 py-2 text-xs font-semibold text-left transition-colors flex items-center justify-between cursor-pointer ${
                          currentTimeframe === opt.value 
        ...
        <Link 
          ...
          className="bg-white border border-slate-200/60 p-6 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between min-h-[120px] hover:scale-[1.01] cursor-pointer"
        >
        ...
        <div className="bg-white border border-slate-200/60 p-6 rounded-2xl shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-1.5">
              ...
              <span className="h-1.5 w-4 rounded-full bg-[#2563eb]"></span>
            </div>
            <div className="relative">
              <button 
                onClick={(e) => {
                ...
                className="px-2 py-0.5 rounded bg-slate-50 border border-slate-100 text-[10px] font-bold text-slate-500 hover:bg-slate-100 transition-colors cursor-pointer"
              >
                {currentLabel} ▾
              </button>
